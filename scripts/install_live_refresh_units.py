#!/usr/bin/env python3
"""Compatibility entrypoint for the recurrence live-refresh unit installer."""
...
def _load_impl() -> ModuleType:
    ...
    spec = importlib.util.spec_from_file_location(
        "_aoa_stats_live_refresh_unit_installer",
        IMPL_PATH,
    )
    if spec is None or spec.loader is None:
        raise RuntimeError(f"cannot load live refresh unit installer: {IMPL_PATH}")
