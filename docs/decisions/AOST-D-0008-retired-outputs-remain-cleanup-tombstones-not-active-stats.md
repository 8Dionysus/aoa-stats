...
python -m pytest -q tests/test_stats_source_home.py tests/test_summary_surface_catalog.py tests/test_build_views.py mechanics/recurrence/parts/live-receipt-refresh/tests mechanics/titan/parts/incarnation-summon/tests
