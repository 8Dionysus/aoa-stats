...
WAVE3_STEMS = (
    "adoption_dashboard_rollup",
    "adoption_metric_event",
    "adoption_noise_suppression_summary",
    "adoption_retention_summary",
    "adoption_rollback_metric",
    "cross_repo_signal_rollup",
    "federation_adoption_metrics",
    "federation_recurrence_summary",
    "harvest_dashboard_rollup",
    "kag_promotion_metrics",
    "noise_suppression_summary",
    "office_adoption_health_summary",
    "pattern_quality_metric_event",
    "shadow_run_metric_summary",
)
