...
WAVE5_CONTRACTS = (
    ('handoff_health_summary_v1', 'handoff_health_summary_v1.json'),
    ('installation_dashboard_v1', 'installation_dashboard_v1.json'),
    ('office_incident_rollup_v1', 'office_incident_rollup_v1.json'),
    ('office_mesh_metrics_summary_v1', 'office_mesh_metrics_summary_v1.json'),
    ('operator_console_metrics_v1', 'operator_console_metrics_v1.json'),
    ('release_health_summary_v1', 'release_health_summary_v1.json'),
    ('release_train_dashboard_v1', 'release_train_dashboard_v1.json'),
    ('smoke_test_rollup_v1', 'smoke_test_rollup_v1.json'),
)
