...
WAVE4_CONTRACTS = (
    ('appeal_metric_summary', 'appeal_metric_summary_v1.json'),
    ('governance_metric_rollup', 'governance_metric_rollup_v1.json'),
    ('policy_decision_metric_summary', 'policy_decision_metric_summary_v1.json'),
    ('veto_metric_summary', 'veto_metric_summary_v1.json'),
    ('runtime_queue_summary_v1', 'runtime_queue_summary_v1.json'),
)
