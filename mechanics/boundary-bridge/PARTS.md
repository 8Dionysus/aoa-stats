...
| `measurement-packet-crossing` | validate and combine compatible owner-local packets and validate C10 outcome observations without taking metric, task-result, or verdict ownership | `measurement_contract`, `federation` | localized |
