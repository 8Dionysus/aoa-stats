...
SRC = PART_ROOT / 'config/agon_kag_stats_observability.seed.json'
OUT = ROOT / 'generated/agon_kag_stats_observability_registry.min.json'
ENTRY_SCHEMA = PART_ROOT / 'schemas/agon-kag-stats-observability.schema.json'
REGISTRY_SCHEMA = PART_ROOT / 'schemas/agon-kag-stats-observability-registry.schema.json'
BUILDER = PART_ROOT / 'scripts/build_agon_kag_stats_observability_registry.py'
