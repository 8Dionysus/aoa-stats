...
SCRIPT = PART_ROOT / 'scripts/build_agon_sophian_stats_observability_registry.py'
VALIDATOR = PART_ROOT / 'scripts/validate_agon_sophian_stats_observability_registry.py'
EXPECTED_COUNT = 6
