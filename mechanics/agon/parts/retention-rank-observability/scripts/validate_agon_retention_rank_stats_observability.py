...
SCHEMA = PART_ROOT / "schemas/agon-retention-rank-stats-observability-registry.schema.json"
BUILDER = PART_ROOT / "scripts/build_agon_retention_rank_stats_observability_registry.py"
