...
SRC = PART_ROOT / 'config/agon_mechanical_trial_stats_observability.seed.json'
...
REQUIRED_FIELDS = ['id', 'trial_id', 'summary_candidates', 'allowed_dimensions', 'live_protocol', 'runtime_effect', 'live_verdict_authority', 'durable_scar_write', 'rank_mutation', 'retention_execution', 'tos_promotion']
